 ...
 * Bugs still hapen:
 * 1º table keys in end of table missing. So donŽt let your table keys in end of table fields
 * 
 * License: LGPL 
 * 
...
?>"; 
	...
	/**
     * Create Directory to save the files if donŽt exist
     * 
     */
